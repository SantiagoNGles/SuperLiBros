...
<form action="<?php echo BASE_URL; ?>?action=register&subaction=process" method="post" novalidate>
    ...
    <div class="form-group">
        ...
        <input type="password" id="password" name="password" required aria-required="true" minlength="12">
        <small>Le mot de passe doit contenir au moins 12 caractères.</small>
    </div>
